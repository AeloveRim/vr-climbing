...
void InputManager::Initialize()
{
	...
	if (!m_hookManager) {
		spdlog::error("VR Climbing: Failed to get OpenVRHookManagerAPI - is SkyrimVRTools installed?");
		RE::DebugNotification("VR Climbing: SkyrimVRTools not found! Mod will not work.");
